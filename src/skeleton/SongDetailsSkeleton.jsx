...
const SongDetailsSkeleton = () => {
  return (
    <>
      <div className="mt-6 xl:mt-0 xl:ml-0 mb-4 sm:ml-[12rem] flex items-center gap-4 pl-4 xl:absolute xl:top-20 xl:left-55">
        <div className="h-6 w-30 animate-pulse rounded-2xl bg-gray-800 xl:h-10 xl:w-40"></div>
      </div>

      <section className="hide-scrollbar xl:ml-0 sm:ml-[12rem] mt-4 overflow-y-scroll px-4 xl:absolute xl:top-30 xl:left-55 xl:h-[calc(100vh_-_12rem)] xl:w-[82%]">
